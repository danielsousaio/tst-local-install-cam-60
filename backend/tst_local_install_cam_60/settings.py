"""
Django settings for tst_local_install_cam_60 project.
...
ROOT_URLCONF = 'tst_local_install_cam_60.urls'
...
WSGI_APPLICATION = 'tst_local_install_cam_60.wsgi.application'
