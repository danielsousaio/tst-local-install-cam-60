...
## Project Structure
    ...
    ├── tst_local_install_cam_60  # Django project configurations
...
1. Clone this repo and `cd tst_local_install_cam_60`
...
2. Clone this repo and `cd tst_local_install_cam_60`
